  ...
  return (
    ...
    >
      <div className="wrapper border-x border-[#BEBEBE] lg:border-none flex flex-col lg:items-start items-center gap-7 sm:py-[5rem] lg:py-[8rem] py-[14rem]">
        <h1 className="text-6xl sm:text-2xl lg:leading-10 lg:max-w-[500px] sm:font-normal whitespace-nowrap lg:lowercase lg:whitespace-normal lg:text-left  xl:text-[2.7rem] relative text-pretty text-center font-semibold">
