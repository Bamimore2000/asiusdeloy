    ...
    return (
      <div className="w-full">
        ...
        <input
          ...
          className={`appearance-none placeholder:text-gray-700 peer border-2 border-gray-500 p-2 rounded w-full py-4 px-3 text-gray-900 leading-tight focus:border-secondary-200 focus:outline-none 
